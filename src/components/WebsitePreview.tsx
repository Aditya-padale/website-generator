      ...
      {isFullscreen && (
        <div className="fixed inset-0 z-50 bg-black">
          ...
          <div className="flex items-center justify-between p-4 bg-gray-900 border-b border-gray-700">
            ...
            <div className="flex-1 mx-4 px-4 py-1.5 bg-gray-800 text-gray-400 rounded-md text-sm text-center font-mono truncate">
              preview.webgen.ai - Fullscreen Mode
            </div>
            <div className="flex items-center gap-2">
              <button 
                onClick={handleRefresh}
              ...
              <button 
                onClick={toggleFullscreen}
                className="p-1.5 text-gray-400 hover:text-white hover:bg-red-600 rounded-md transition-colors"
                title="Close"
              >
                <X className="w-4 h-4" />
              </button>
